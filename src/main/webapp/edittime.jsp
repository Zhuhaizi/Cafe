                    ...
                    <div class="align-items-center" id="bill">
                        <div class="p-3">
                            ...
                            <form action="edittime" method="post">
                                <div class="row g-3">
                                    <div class="col-12" style="display: none">
                                        <div class="form-floating">
                                            <input type="text"class="form-control" name="o_id" value="${o.getO_id()}" required readonly>
                                    </div>
                                </div>
                                <div class="col-12" style="display: none">
                                    <div class="form-floating">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="datetime-local" class="form-control" id="time" name="time" value="${o.getO_time_start()}"
                                               placeholder="Thời gian" max="${now}" required>
