                    ...
                    <div class="align-items-center" id="bill">
                        <div class="p-3">
                            ...
                            <form action="edititem" method="post">
                                ...
                                <div class="col-12" style="display: none">
                                    <div class="form-floating">
                                        <input type="text"class="form-control" name="oi_general_id" value="${oi_general_id}" required readonly>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                ...
                                <div class="col-12 align-items-center">
                                    <button class="btn btn-primary btn-blue-check w-100 py-3" type="submit" name="btnOtherEdit">Xác nhận</button>
                                </div>
                            </div>
                        </form>
                    </div>
